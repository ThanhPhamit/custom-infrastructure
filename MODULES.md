...
| rds_scheduler | Start/stop RDS instances on a cron (EventBridge Scheduler universal targets, no Lambda). Sibling of ec2_scheduler — see its DELIBERATELY ABSENT note before adding retries | app_name, db_instance_arns | schedule_names, role_arn | tokyo-prod |
